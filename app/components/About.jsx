        ...
        className='flex w-full flex-col lg:flex-row items-center gap-20 my-20'>
            ...
            className='flex-1'>
                <p className='mb-10 max-w-2xl font-Ovo'>
                    Saya adalah seorang Mahasiswa aktif dengan fokus pada pengembangan perangkat lunak. Saya memiliki minat dalam mempelajari bahasa pemrograman dan teknologi web, serta semangat untuk terus berkontribusi dalam industri teknologi. Saya percaya bahwa pembelajaran yang berkelanjutan dan kolaborasi adalah kunci untuk mencapai kesuksesan dalam bidang ini.
                </p>
